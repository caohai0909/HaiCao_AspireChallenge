...
public class BuiltInAction {
    ...
    public static void enter(By locator, String contents) {
        try {
            ...
            getWebElement(locator).sendKeys(contents);
    ...
    public static void checkControlProperty(By locator, String attribute, String value) {
        try {
            ...
            if (realLocator == true) {
                String realValue = getWebElement(locator).getAttribute(attribute);
                if (realValue == value) {
    ...
    public static void attachFile(By location, String filePath) {
        try {
            ...
            getWebElement(location).sendKeys(filePath);
        } catch (Exception err) {
     ...
     * throws Exception
     */
    public static Iterator<Object[]> dataParse(String jsonPath) throws Exception{
        ...
        for(int i=0;i<itemList.size();i++){
            list.add(new Object[]{itemList.get(i)});
        }
